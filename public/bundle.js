...
/******/ 	var hotCurrentHash = "899f0f7baa221296caf3"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var _components_Button_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Button.html */ "./src/components/Button.html");
...
function create_main_fragment(component, ctx) {
	...
	var button_initial_data = { text: "Next page" };
	var button = new _components_Button_html__WEBPACK_IMPORTED_MODULE_1__["default"]({
		root: component.root,
		data: button_initial_data
	});

	var button_1_initial_data = { text: "Next page", variant: "outline" };
	var button_1 = new _components_Button_html__WEBPACK_IMPORTED_MODULE_1__["default"]({
		root: component.root,
		data: button_1_initial_data
	});

	var button_2_initial_data = { text: "Next page", variant: "clear" };
	var button_2 = new _components_Button_html__WEBPACK_IMPORTED_MODULE_1__["default"]({
		root: component.root,
		data: button_2_initial_data
	});

	var button_3_initial_data = { text: "Next page", size: "large" };
	var button_3 = new _components_Button_html__WEBPACK_IMPORTED_MODULE_1__["default"]({
		root: component.root,
		data: button_3_initial_data
	});

	var button_4_initial_data = { text: "Next page", size: "small" };
	var button_4 = new _components_Button_html__WEBPACK_IMPORTED_MODULE_1__["default"]({
		root: component.root,
...
if (true) {
	...
	if (!module.hot.data) {
		// initial load
		configure({});
		App = register("src/App.html", App);
	} else {
		// hot update
		App = reload("src/App.html", App);
	}
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/shared.js */ "./node_modules/svelte/shared.js");
/* harmony import */ var _Users_rbezerra_code_milligram_sveltejs_src_components_Button_svelte_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/components/Button.svelte.css */ "./src/components/Button.svelte.css");
/* harmony import */ var _Users_rbezerra_code_milligram_sveltejs_src_components_Button_svelte_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_Users_rbezerra_code_milligram_sveltejs_src_components_Button_svelte_css__WEBPACK_IMPORTED_MODULE_1__);
/* src/components/Button.html generated by Svelte v2.4.4 */
...
function css({ variant, size }) {
   ...
   return Object.keys(classList).filter(name => classList[name]).join(' ');
}
...
function create_main_fragment(component, ctx) {
	...
	return {
		c() {
			...
			text = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["createText"])(ctx.text);
			button.type = ctx.type;
			button.className = "" + ctx.css + " svelte-1oltxiy";
		},
...
function Button(options) {
	Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["init"])(this, options);
	this._state = Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["assign"])({}, options.data);
	this._recompute({ type: 1, variant: 1, size: 1 }, this._state);
...
Object(svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["assign"])(Button.prototype, svelte_shared_js__WEBPACK_IMPORTED_MODULE_0__["proto"]);
...
Button.prototype._recompute = function _recompute(changed, state) {
	...
	if (changed.variant || changed.size) {
		if (this._differs(state.css, (state.css = css(state)))) changed.css = true;
	}
}
...
if (true) {
	...
	if (!module.hot.data) {
		// initial load
		configure({});
		Button = register("src/components/Button.html", Button);
	} else {
		// hot update
		Button = reload("src/components/Button.html", Button);
	}
}
...
/***/ "./src/components/Button.svelte.css":
/*!******************************************!*\
  !*** ./src/components/Button.svelte.css ***!
  \******************************************/
...
let app = new _App_html__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
/***/ 0:
/*!******************************************!*\
  !*** multi ./src/main.css ./src/main.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/main.css */"./src/main.css");
